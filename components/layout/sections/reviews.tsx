    ...
    >
      <div className="flex flex-row items-center gap-2">
        ...
        <div className="flex flex-col">
          <figcaption className="text-sm font-semibold text-orange-500">
            {name}
          </figcaption>
...
export function MarqueeDemo() {
  return (
    <div id="clients" className="relative flex w-full flex-col items-center justify-center overflow-hidden py-10">
      <Marquee pauseOnHover className="mb-2 [--duration:40s]">
        {firstRow.map((review) => (
